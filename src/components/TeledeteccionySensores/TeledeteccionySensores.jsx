...
<div className="container cartitassatelites">
  <div className="row">
    <div className="card shadow p-3 mb-5 bg-white rounded col-md-4  col-sm-4  col-xs-12 text-center minicarta"> 
    <div className="card-body"> 
...
<section class="cartitasradar">
  <div className="container cartitas">
  <div className="row">
    <div className="card shadow p-3 mb-5 bg-white rounded col-md-4  col-sm-4  col-xs-12 text-center minicarta"> 
    <div className="card-body"> 
        <h5 className="card-title">Mapas de inundación</h5>
        <p className="card-text">Supervisa los avances con alta resolución de imagen</p>
      </div>
    </div>
    ...
    <div className="card shadow p-3 mb-5 bg-white rounded col-md-4  col-sm-4  col-xs-12 text-center minicarta">
    <div className="card-body">
        <h5 className="card-title">Monitoreo de Desplazamiento del Terreno</h5>
        <p className="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
      </div>
    </div>  
    ...
    <div className="card shadow p-3 mb-5 bg-white rounded col-md-4  col-sm-4  col-xs-12 text-center minicarta">
    <div className="card-body">
        <h5 className="card-title">Seguimiento de Obra</h5>
        <p className="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
      </div>
    </div>
  ...
  <div className="row">
    <div className="card shadow p-3 mb-5 bg-white rounded col-md-4  col-sm-4  col-xs-12 text-center minicarta"> 
    <div className="card-body"> 
        <h5 className="card-title">Análisis de amplitud y Series de tiempo</h5>
        <p className="card-text">Supervisa los avances con alta resolución de imagen</p>
      </div>
    </div>
    ...
    <div className="card shadow p-3 mb-5 bg-white rounded col-md-4  col-sm-4  col-xs-12 text-center minicarta">
    <div className="card-body">
        <h5 className="card-title">Detección de Derrames de Petróleo</h5>
        <p className="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
      </div>
    </div>  
    ...
    <div className="card shadow p-3 mb-5 bg-white rounded col-md-4  col-sm-4  col-xs-12 text-center minicarta">
    <div className="card-body">
        <h5 className="card-title">Seguimientode incendios forestales</h5>
        <p className="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
      </div>
    </div>
