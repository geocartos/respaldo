...
<div className="container sectores">
  ...
  <div className="row sectoresfila">
    <div className="col-md-4 col-sm-6 col-xs-12 sectores text-center ">
      ...
      <h4 className="sectoresgeotos"><NavLink to="/IngenieriayConstruccion">Ingeniería y Construcción</NavLink></h4> 
    </div>
    ...
    <div className="col-md-4 col-sm-6 col-xs-12 sectores text-center ">
      ...
      <h4 className="sectoresgeotos"> <NavLink to="/LogisticayTransporte">Logística y Transporte</NavLink> </h4>
    </div>

    <div className="col-md-4 col-sm-6 col-xs-12 sectores text-center ">
      <img className="sectoresicono" src={sectornatural} alt="" />
      <h4 className="ssectoresgeotos"> <NavLink to="/RecursosnaturalesyMedioambiente">Recursos naturales y Medio ambiente</NavLink> </h4>
    </div>

    <div className="col-md-4 col-sm-6 col-xs-12 sectores text-center ">
      <img className="sectoresicono" src={sectornegocios} alt="" />
      <h4 className="sectoresgeotos"> <NavLink to="/NegociosyFinanzas">Negocios y Finanzas</NavLink> </h4>
    </div>
