    ...
    <img className="card-img-top" src={arcgis}  alt=" " />
          <div className="card-body">
            <h5 className="card-title">ArcGIS</h5>
              ...
              <p><i className="fa-duotone fa-calendar"></i> Sábados del 03/05/2022 al 23/06/2022</p>
              <p><i className="fa-solid fa-clock"></i> 12 hrs</p>
              <p><i className="fa-solid fa-money-bill-simple-wave"></i> $12 peso mexicano </p>
